    ...
    client.on("message", async message => {
        ...
        if (msg.content === `<@!${bot.user.id}>` || msg.content === `<@${bot.user.id}>`) {
            const mentionEmbed = new MessageEmbed()
 			...
 			.setDescription("Cześć, bot Hasfy.pl nie jest już aktualny! Dodaj nowego [bota](https://discord.com/oauth2/authorize?client_id=808009436513566811&permissions=8&scope=bot) bądź dołacz na nowy serwer [wsparcia](https://discord.gg/e9ZzM7thYa)!\nMożesz wciąż używać bota Hasfy.pl, ponieważ działa on z komendami ale zalecamy dodać nowego bota, ten nie będzie wspierany.")
